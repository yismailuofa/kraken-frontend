...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Sprints', icon: GrCycle, page: "/projectlist" }, // TODO: update the page route when the sprint list page is created
...
export function SideNavBar() {
  ...
  return (
    <Box h="100vh" w="60" mr="10" bg={useColorModeValue('gray.100', 'gray.900')}>
