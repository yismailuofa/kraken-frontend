...
Running Kraken locally requires you have Node.js installed. The download for Node.js can be found here:
...
Alternatively, you can go to the following web page to use the latest version of Kraken deployed through GitHub Pages:

### https://yismailuofa.github.io/kraken-frontend/
...
This command will deploy the app to github pages.

### `npm run generate-client`

This command will generate the client code from the backend. You must have the backend running to use this command.